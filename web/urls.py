...
from .views.admin_views import (
    lista_ciclos, ciclos_sede_detalle,
    lista_sedes, crear_sede, editar_sede, eliminar_sede, reactivar_sede,
    crear_usuario, lista_usuarios, editar_usuario, eliminar_usuario, reactivar_usuario,
    crear_ciclo, editar_ciclo, eliminar_ciclo,
    configuracion,
)
...
urlpatterns = [
    ...
    # ── DASHBOARD (bifurca por rol: admin o secretaria) ──────────────────
    ...
    # ── SECRETARIA — REGISTRO DE ALUMNO (flujo de 4 pasos) ───────────────
    path("secretaria/registrar-alumno/",     registrar_alumno,    name="registrar_alumno"),
    path("secretaria/registrar-apoderado/",  registrar_apoderado, name="registrar_apoderado"),
    path("secretaria/formacion-academica/",  regis_form_academica, name="regis_form_academica"),
    path("secretaria/formacion-adicional/",  regis_form_adicional, name="regis_form_adicional"),
    path("secretaria/cancelar-registro/",    cancelar_registro,   name="cancelar_registro"),
    path("secretaria/nuevo-registro/",       nuevo_registro,      name="nuevo_registro"),

    # ── SECRETARIA — MATRÍCULAS Y PAGOS ──────────────────────────────────
